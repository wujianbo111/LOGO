...
RadioTextType code DrawBrightnessTextRatio[] =
{
	...
	{dwiEnd | dwiRadioGroup | dwiMainTitle,		MainMenuIcon_DrawXPos + 0x02, 		MainMenuIcon_DrawYPos + 2 * MAIN_BriContrast_ITEM - 1,		MainMenu_BrightText}
};
...
// 2 ColorTemp
	{
		MainMenuIcon_DrawXPos + 0x02, MainMenuIcon_DrawYPos + 2 * MAIN_RGBColor_ITEM + 1,		// XPos, YPos;
		NotSelectedForeAndBackColor, Color_2, // ForeColor, BackColor;
		SelectedForeAndBackColor, Color_2, // SelForeColor, SelBackColor;
...
// 3  OSD
	{
		MainMenuIcon_DrawXPos + 0x0E, MainMenuIcon_DrawYPos + 2 * MAIN_Osd_ITEM - 1,		// XPos, YPos;
		NotSelectedForeAndBackColor, Color_2, // ForeColor, BackColor;
		SelectedForeAndBackColor, Color_2, // SelForeColor, SelBackColor;
...
// 4  Reset
	{
		MainMenuIcon_DrawXPos + 0x02, MainMenuIcon_DrawYPos + 2 * MAIN_Setting_ITEM + 3,		// XPos, YPos;
		NotSelectedForeAndBackColor, Color_2, // ForeColor, BackColor;
		SelectedForeAndBackColor, Color_2, // SelForeColor, SelBackColor;
		...
		},
		{
			NULL, // DrawNumberType
			NULL, // DrawGuageType
			NULL, //DrawResetTextRatioGroup, // DrawRadioGroupType
		},
		MenuPage7, //Font
		mibSelectable  // Flags
	},
// 5  Misc
	{
		MainMenuIcon_DrawXPos + 0x0E, MainMenuIcon_DrawYPos + 2 * MAIN_Misc_ITEM + 1,		// XPos, YPos;
		NotSelectedForeAndBackColor, Color_2, // ForeColor, BackColor;
		SelectedForeAndBackColor, Color_2, // SelForeColor, SelBackColor;
