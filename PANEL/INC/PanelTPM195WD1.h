#ifndef _PanelTPM195WD1_
#define _PanelTPM195WD1_
#define PanelType_1600x900
#define PanelName               "PanelTPM195WD1"
...
#define PanelOnTiming1          20//50//30//20//60//20 // time between panel & data while turn on power
...
#define PanelOffTiming2         20//25 // 2005/5/3//10 // time between data & panel while turn off power 
...
#define PanelHTotal     		2112//1800
#define PanelVTotal     		926//1000

#define PanelMaxHTotal      	2300//2400
#define PanelMinHTotal      	1900//1696
#define PanelMaxVTotal      	942//1300
#define PanelMinVTotal          905//908

#define PanelDCLK               118//108
#define PanelMaxDCLK            162//136
#define PanelMinDCLK           	86//87

// 111003 Rick add
#define PanelVfreq          	(600)
#define PanelMaxVfreq   		(750+20) // 75Hz
#define PanelMinVfreq   		(500-20) // 50Hz
#define LVDS_VOLTAGE_TARGET  IGT_TARGET_200
//=================================================================
...
#define PANEL_PERCENTAGE      3//2.8  // 0.5~3%
