#ifndef __PANEL_TPM215HW01_HTN01__   //PanelTPM215HW01
#define __PANEL_TPM215HW01_HTN01__
...
#elif ModelName==AOC_E2273FW//petit 20132
#define PanelSwapPort		0xFF
#else
...
#define PanelOnTiming2		575 //xuebo modify 500 to 575 // // T5 >= 450ms // time between data & back light while turn on power
#define PanelOffTiming1		140// t6 >= 90ms // time between back light & data while turn off power 
#define PanelOffTiming2		1//5  // 20// T3 <= 50ms // time between data & panel while turn off power 
#define PanelOffOnDelay        1100//550 // T4 >= 500ms
...
#define PanelVSyncBackPorch	13
 ...
 #define PanelMinHTotal     2068//2112
 
 #define PanelMaxVTotal     1818//1136 
 #define PanelMinVTotal     1092//1115
 
 #define PanelDCLK          142//149
 #define PanelMaxDCLK       188//195
 #define PanelMinDCLK       113//118
