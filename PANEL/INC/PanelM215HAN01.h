...
#define PanelName           "PanelM215HAN01"
...
#define PanelOnTiming1      80//60//20 // time between panel & data while turn on power
#define PanelOnTiming2      600//350//220 // time between data & back light while turn on power
#define PanelOffTiming1     200//350//220 // 2005/5/3// time between back light & data while turn off power
