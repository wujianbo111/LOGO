// for samsung_panel
#define PanelName               "PanelLM230WF3-S3L2"
...
#if (MainBoardType==MainBoard_7269_M0A) || (MainBoardType==MainBoard_7277_M0B) || (MainBoardType==MainBoard_7581_M0A)//20141126 Gino
