#ifndef _PanelINXM195FGE_L20_
#define _PanelINXM195FGE_L20_
#define PanelType_1600x900
#define PanelName               "M195FGE-L20"
...
#define PanelOffTiming2		20// petit  20130903// T5 <= 50ms // time between data & panel while turn off power 
