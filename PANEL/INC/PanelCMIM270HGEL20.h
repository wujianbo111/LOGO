    #if ModelName==AOC_E2795VG||ModelName==ENVISION_G2770L_2//petit 20130911
    #define PanelName               "Panel INXM270HGEL30"	
    #else
    #define PanelName               "PanelCMIM270HGEL20"	
    #endif
...
#if  MainBoardType==MainBoard_5863_M0A		//Fay 2013/4/25   
...
#if  MainBoardType==MainBoard_5863_M0A		//Fay 2013/4/25   
    #define PanelOffTiming2   5 //  time between data & panel while turn off power
#else
...
#define SAR_V_8p00              0xC5//20130509 from MST hunyi.cai
