// for samsung_panel
#define PanelName               "PanelLM230WF3-S2L1"
...
#if (MainBoardType==MainBoard_7379_M0A||MainBoardType==MainBoard_8278_M0A)// Alpha Add 20141106
...
#if (MainBoardType==MainBoard_7269_M0A)//20141225 Gino
