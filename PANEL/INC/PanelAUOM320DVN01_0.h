#ifndef __AUOM320DVN01_0_H// petit 20130621
#define __AUOM320DVN01_0_H

#define PanelName   "AUOM320DVN01"
...
#define LVDS_CH_D_SWAP              LVDS_CH_C
...
#define LVDS_TI_BitModeSel  LVDS_TI_10BIT//20130801 petit
...
#define PanelMinHTotal      2716
#define PanelMaxVTotal      3755
#define PanelMinVTotal      1452
#define PanelVsyncFreq      60
//#define PanelMaxVsyncFreq      (600+13)//20130801  no use
#define PanelMaxVfreq      (750+13)//20130801 by EE spec
...
#define PanelDCLK           241// (((DWORD)PanelHTotal*PanelVTotal*PanelVsyncFreq)/1000000)
