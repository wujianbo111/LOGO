// for samsung_panel
#if ModelName==AOC_I2281FW
#define PanelName               "LM215WF3-S3L3"
#else
#define PanelName               "LM215WF3-S3L1"
#endif
...
#if (MainBoardType==MainBoard_7379_M0A)// 2014115 alpha
...
#if(MainBoardType==MainBoard_7762_M0A)|| (MainBoardType==MainBoard_7269_M0A) || (MainBoardType==MainBoard_7277_M0B) || (MainBoardType==MainBoard_7581_M0A)//20141126 Gino
