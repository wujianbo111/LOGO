#ifndef _PanelTPM270WF1_MWN1_   
#define _PanelTPM270WF1_MWN1_

#define PanelName       "TPM270WF1-MWN1"
...
#define PanelOffTiming2		5//15  //  time between data & panel while turn off power 
#define PanelOffOnDelay        600 // T7
