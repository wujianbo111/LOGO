#ifndef _PanelCMIM195FGE_
#define _PanelCMIM195FGE_
#define PanelType_1600x900
#define PanelName               "CMIM195FGE"
...
#define _PanelOnTiming1          	25//60//20 // time between panel & data while turn on power
#define _PanelOnTiming2          	500//550//350//220 // time between data & back light while turn on power
#define _PanelOffTiming1         	250//350//220 // 2005/5/3// time between back light & data while turn off power 
#define _PanelOffTiming2         	25//20//25 // 2005/5/3//10 // time between data & panel while turn off power 
