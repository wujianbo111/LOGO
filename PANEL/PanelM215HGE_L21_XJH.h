...
#define PanelOnTiming1      25//40//60//20 // time between panel & data while turn on power
#define PanelOnTiming2      450//600//350//220 // time between data & back light while turn on power
#define PanelOffTiming1     90//150//220 // 2005/5/3// time between back light & data while turn off power
#define PanelOffTiming2     25//40//20//25 // 2005/5/3//10 // time between data & panel while turn off power
