...
#define hw_SetDDC_WP()		( msWriteBit(_REG_PMGPIO0_OEZ, 1, BIT5),msWriteBit(_REG_PMGPIO0_OUT, 1, BIT5))//MEM_MSWRITE_BIT(_REG_PMGPIO0_OUT, 0, BIT5)
#define hw_ClrDDC_WP()		(msWriteBit(_REG_PMGPIO0_OEZ, 0, BIT5),msWriteBit(_REG_PMGPIO0_OUT, 0, BIT5))//MEM_MSWRITE_BIT(_REG_PMGPIO0_OUT, 1, BIT5)
#define Init_hwDDC_WP_Pin()  MEM_MSWRITE_BIT(_REG_PMGPIO0_OEZ, 1, BIT5)
...
#define hwDVICable_Pin      		0//(_bit1_(MEM_MSREAD_BYTE(_REG_PMGPIO0_IN)))
#define Init_hwDVICable_Pin()   	//(MEM_MSWRITE_BIT(_REG_PMGPIO0_OEZ,1,BIT1)) // input enable

#if ENABLE_HDMI
#define hwHDMICable_Pin			0//(_bit5_(MEM_MSREAD_BYTE(_REG_GPIO2_IN)))
#define Init_hwHDMICable_Pin()	//(MEM_MSWRITE_BIT(_REG_GPIO2_OEZ,1,BIT5))
#endif
//========================================================
// 5.Led
...
#define hw_SetAmberLed()           MEM_MSWRITE_BIT(_REG_GPIO1_OUT, 1, BIT0)
#define hw_ClrAmberLed()           MEM_MSWRITE_BIT(_REG_GPIO1_OUT, 0, BIT0)
#define Init_hwAmberLed_Pin()   MEM_MSWRITE_BIT(_REG_GPIO1_OEZ, 0, BIT0) // output enable
//========================================================
// 6.Audio control:
#define hwMute_Pin
#define hw_SetMute()			//MEM_MSWRITE_BIT(_REG_GPIO0_OUT, 1, BIT0)
#define hw_ClrMute()			//MEM_MSWRITE_BIT(_REG_GPIO0_OUT, 0, BIT0)
...
#define Init_NVRAM_I2C_SDA_Pin()		//(MEM_MSWRITE_BIT(_REG_PMGPIO1_OEZ, TRUE, BIT3))
#define Init_NVRAM_I2C_SCL_Pin()		//(MEM_MSWRITE_BIT(_REG_PMGPIO2_OEZ, TRUE, BIT2))

#define INIT_HW_VGAI2C_SDA_PIN()    	(MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, TRUE, BIT7))
#define INIT_HW_VGAI2C_SCL_PIN()    		(MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, TRUE, BIT6))

#define Set_i2c_SDA_VGA()           			(MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, TRUE, BIT7))
#define Clr_i2c_SDA_VGA()           			(MEM_MSWRITE_BIT(_REG_GPIO0_OUT, FALSE, BIT7), MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, FALSE, BIT7))
#define i2c_SDAHi_VGA()              			(_bit7_(MEM_MSREAD_BYTE(_REG_GPIO2_IN)))
#define i2c_SDALo_VGA()              			(!i2c_SDAHi_VGA())

#define Set_i2c_SCL_VGA()           			(MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, TRUE, BIT6))
#define Clr_i2c_SCL_VGA()           			(MEM_MSWRITE_BIT(_REG_GPIO0_OUT, FALSE, BIT6), MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, FALSE, BIT6))
#define i2c_SCLHi_VGA()              			(_bit6_(MEM_MSREAD_BYTE(_REG_GPIO0_IN)))
#define i2c_SCLLo_VGA()              			(!i2c_SCLHi_VGA())

#define INIT_HW_DVII2C_SDA_PIN()    (MEM_MSWRITE_BIT(_REG_PMGPIO2_OEZ, TRUE, BIT2))
#define INIT_HW_DVII2C_SCL_PIN()    (MEM_MSWRITE_BIT(_REG_PMGPIO2_OEZ, TRUE, BIT1))

#define Set_i2c_SDA_DVI()           			(MEM_MSWRITE_BIT(_REG_PMGPIO2_OEZ, TRUE, BIT2))
#define Clr_i2c_SDA_DVI()           			(MEM_MSWRITE_BIT(_REG_PMGPIO2_OUT, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_PMGPIO2_OEZ, FALSE, BIT2))
#define i2c_SDAHi_DVI()              			(_bit2_(MEM_MSREAD_BYTE(_REG_PMGPIO2_IN)))
#define i2c_SDALo_DVI()              			(!i2c_SDAHi_DVI())

#define Set_i2c_SCL_DVI()           			(MEM_MSWRITE_BIT(_REG_PMGPIO2_OEZ, TRUE, BIT1))
#define Clr_i2c_SCL_DVI()           			(MEM_MSWRITE_BIT(_REG_PMGPIO2_OUT, FALSE, BIT1), MEM_MSWRITE_BIT(_REG_PMGPIO2_OEZ, FALSE, BIT1))
#define i2c_SCLHi_DVI()              			(_bit1_(MEM_MSREAD_BYTE(_REG_PMGPIO2_IN)))
#define i2c_SCLLo_DVI()              			(!i2c_SCLHi_DVI())

#define Set_NVRAM_i2c_SDA()       ((EnableReadDDCType == DVI_EDID)?(Set_i2c_SDA_DVI()):(Set_i2c_SDA_VGA()))
#define Clr_NVRAM_i2c_SDA()       ((EnableReadDDCType == DVI_EDID)?(Clr_i2c_SDA_DVI()):(Clr_i2c_SDA_VGA()))
#define NVRAM_i2c_SDA_IS_HI()         ((EnableReadDDCType == DVI_EDID)?(i2c_SDAHi_DVI()):(i2c_SDAHi_VGA()))
#define NVRAM_i2c_SDA_IS_LO()         ((EnableReadDDCType == DVI_EDID)?(i2c_SDALo_DVI()):(i2c_SDALo_VGA()))

#define Set_NVRAM_i2c_SCL()           ((EnableReadDDCType == DVI_EDID)?(Set_i2c_SCL_DVI()):(Set_i2c_SCL_VGA()))
#define Clr_NVRAM_i2c_SCL()           ((EnableReadDDCType == DVI_EDID)?(Clr_i2c_SCL_DVI()):(Clr_i2c_SCL_VGA()))
#define NVRAM_i2c_SCL_IS_HI()         ((EnableReadDDCType == DVI_EDID)?(i2c_SCLHi_DVI()):(i2c_SCLHi_VGA()))
#define NVRAM_i2c_SCL_IS_LO()         ((EnableReadDDCType == DVI_EDID)?(i2c_SCLLo_DVI()):(i2c_SCLLo_VGA()))
#endif
...
#define hw_Set_HdcpHpd()        //(MEM_MSWRITE_BIT(_REG_PMGPIO1_OUT, FALSE, BIT5), MEM_MSWRITE_BIT(_REG_PMGPIO1_OEZ, FALSE, BIT5))  //(MEM_MSWRITE_BIT(_REG_PMGPIO2_OUT, FALSE, BIT0), MEM_MSWRITE_BIT(_REG_PMGPIO2_OEZ, FALSE, BIT0))   
#define hw_Clr_HdcpHpd()          //(MEM_MSWRITE_BIT(_REG_PMGPIO1_OUT, TRUE, BIT5), MEM_MSWRITE_BIT(_REG_PMGPIO1_OEZ, TRUE, BIT5))   //(MEM_MSWRITE_BIT(_REG_PMGPIO2_OUT, TRUE, BIT0), MEM_MSWRITE_BIT(_REG_PMGPIO2_OEZ, FALSE, BIT0))
#define Init_hwHDCP_Hpd_Pin()			//

#define hw_Set_HdcpHpd2()           (MEM_MSWRITE_BIT(_REG_PMGPIO2_OUT, FALSE, BIT0), MEM_MSWRITE_BIT(_REG_PMGPIO2_OEZ, FALSE, BIT0))   
#define hw_Clr_HdcpHpd2()            (MEM_MSWRITE_BIT(_REG_PMGPIO2_OUT, TRUE, BIT0), MEM_MSWRITE_BIT(_REG_PMGPIO2_OEZ, TRUE, BIT0))
#define Init_hwHDCP_Hpd_Pin2()    (MEM_MSWRITE_BIT(_REG_PMGPIO2_OEZ, TRUE, BIT0))

#define hw_Set_HdcpHpd3()          //(MEM_MSWRITE_BIT(_REG_PMGPIO1_OUT, FALSE, BIT5), MEM_MSWRITE_BIT(_REG_PMGPIO1_OEZ, FALSE, BIT5)) // (MEM_MSWRITE_BIT(_REG_PMGPIO1_OUT, FALSE, BIT5), MEM_MSWRITE_BIT(_REG_PMGPIO1_OEZ, FALSE, BIT5))  
#define hw_Clr_HdcpHpd3()           // (MEM_MSWRITE_BIT(_REG_PMGPIO1_OUT, TRUE, BIT5), MEM_MSWRITE_BIT(_REG_PMGPIO1_OEZ, TRUE, BIT5)) // (MEM_MSWRITE_BIT(_REG_PMGPIO1_OUT, TRUE, BIT5), MEM_MSWRITE_BIT(_REG_PMGPIO1_OEZ, FALSE, BIT5))
