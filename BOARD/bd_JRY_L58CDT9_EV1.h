...
//130708 petit
#define hw_SetDDC_WP()                  (MEM_MSWRITE_BIT(_REG_GPIO3_OUT,1, BIT6),MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, 1, BIT6))//, DDCWPActiveFlag=1)
#define hw_ClrDDC_WP()                  (MEM_MSWRITE_BIT(_REG_GPIO3_OUT,0, BIT6),MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, 0, BIT6))//, DDCWPActiveFlag=0)
...
#define hw_SetBlacklit()                (MEM_MSWRITE_BIT(_REG_GPIO0_OUT, 0, BIT3), BackLightActiveFlag=1)    //-----tang
#define hw_ClrBlacklit()                (MEM_MSWRITE_BIT(_REG_GPIO0_OUT, 1, BIT3), BackLightActiveFlag=0)
#define Init_hwBlacklit_Pin()           MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, 0, BIT3)//,MEM_MSWRITE_BIT(REG_0262, FALSE, BIT5))// output enable

#define hw_SetPanel()                  MEM_MSWRITE_BIT(_REG_GPIO0_OUT, 1, BIT5)     //---tang
#define hw_ClrPanel()                   MEM_MSWRITE_BIT(_REG_GPIO0_OUT, 0, BIT5) 
#define Init_hwPanel_Pin()           MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, 0, BIT5) // output enable



#if Enable_CheckVcc5V
#define hwDetectVCC5V_Pin         	  (_bit4_(MEM_MSREAD_BYTE(_REG_GPIOSAR_IN)))
#define Init_DetectVCC5V_Pin()        (MEM_MSWRITE_BIT(_REG_GPIOSAR_OEZ, 1, BIT0),MEM_MSWRITE_BIT(_REG_GPIOSAR_OUT, 0, BIT4))
#endif
...
#else
#define hwDSUBCable_Pin                        (_bit3_(MEM_MSREAD_BYTE(_REG_GPIOSAR_IN)))   // (_bit5_(MEM_MSREAD_BYTE(_REG_GPIO5_IN)))//(_bit2_(MEM_MSREAD_BYTE(_REG_PMGPIO0_IN)))
#define Init_hwDSUBCable_Pin()              (MEM_MSWRITE_BIT(_REG_GPIOSAR_OEZ, 1, BIT3)) // (MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, 1, BIT5),MEM_MSWRITE_BIT(REG_0262, FALSE, BIT6))//(MEM_MSWRITE_BIT(_REG_PMGPIO0_OEZ,1,BIT2)) // input enable
#define CABLE_DET_VGA_SAR                   SAR3_EN//  SAR3_EN //FALSE//0
#endif
...
#if ENABLE_HDMI
#define hwHDMICable_Pin   			(_bit3_(MEM_MSREAD_BYTE(_REG_GPIO3_IN)))//(KEYPAD_SAR5)//(_bit0_(MEM_MSREAD_BYTE(_REG_GPIO3_IN)))
#define Init_hwHDMICable_Pin()  		(MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, 1, BIT0))//(MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, 1, BIT0))
#define CABLE_DET_HDMI_SAR    		FALSE
#else
#define CABLE_DETECT_HDMI_USE_SAR    0
...
#define hw_ClrGreenLed()                   {MEM_MSWRITE_BIT(_REG_GPIO2_OEZ,1,BIT3);MEM_MSWRITE_BIT(_REG_GPIO2_OUT,0,BIT3);}// MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, 1,BIT2)
#define Init_hwGreenLed_Pin()            MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, 1,BIT3)// output enable// output enable//  MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, 1,BIT2)// output enable

#define hw_SetAmberLed()                {MEM_MSWRITE_BIT(_REG_GPIO2_OEZ,0,BIT2);MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 1, BIT2);}
#define hw_ClrAmberLed()                {MEM_MSWRITE_BIT(_REG_GPIO2_OEZ,1,BIT2);MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 0, BIT2);}
#define Init_hwAmberLed_Pin()          MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, 1,BIT2)// output enable
//================================================================================================================
//================================================================================================================
// 6.Audio control:
...
#define INIT_HWI2C_SDA_PIN()	(MEM_MSWRITE_BIT(_REG_GPIO4_OEZ, TRUE, BIT1))
#define INIT_HWI2C_SCL_PIN()	(MEM_MSWRITE_BIT(_REG_GPIO4_OEZ, TRUE, BIT0))

#define hw_Set_I2C_SDA_Pin		(MEM_MSWRITE_BIT(_REG_GPIO4_OEZ, FALSE, BIT1),MEM_MSWRITE_BIT(_REG_GPIO4_OUT, TRUE, BIT1))
#define hw_Clr_I2C_SDA_Pin		(MEM_MSWRITE_BIT(_REG_GPIO4_OUT, FALSE, BIT1), MEM_MSWRITE_BIT(_REG_GPIO4_OEZ, FALSE, BIT1))
#define hw_I2C_SDA_HI                  (_bit1_(MEM_MSREAD_BYTE(_REG_GPIO4_IN)))
#define hw_I2C_SDA_LO                  (!hw_I2C_SDA_HI)


#define hw_Set_I2C_SCL_Pin		(MEM_MSWRITE_BIT(_REG_GPIO4_OEZ, FALSE, BIT0),MEM_MSWRITE_BIT(_REG_GPIO4_OUT, TRUE, BIT0 ))
#define hw_Clr_I2C_SCL_Pin		(MEM_MSWRITE_BIT(_REG_GPIO4_OUT, FALSE, BIT0 ), MEM_MSWRITE_BIT(_REG_GPIO4_OEZ, FALSE, BIT0))
#define hw_I2C_SCL_HI		       (_bit0_(MEM_MSREAD_BYTE(_REG_GPIO4_IN)))
...
#define Set_i2c_SDA_VGA()           (MEM_MSWRITE_BIT(_REG_GPIO4_OEZ, FALSE, BIT1),MEM_MSWRITE_BIT(_REG_GPIO4_OUT, TRUE, BIT1))
...
#define Set_i2c_SCL_VGA()           (MEM_MSWRITE_BIT(_REG_GPIO4_OEZ, FALSE, BIT0),MEM_MSWRITE_BIT(_REG_GPIO4_OUT, TRUE, BIT0 ))
...
#define Set_i2c_SDA_HDMI()           (MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, FALSE, BIT3),MEM_MSWRITE_BIT(_REG_GPIO3_OUT, TRUE, BIT3))
...
#define Set_i2c_SCL_HDMI()           (MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, FALSE, BIT2),MEM_MSWRITE_BIT(_REG_GPIO3_OUT, TRUE, BIT2))
...
//DVI HPD
#define hw_Set_HdcpHpd()        	//(MEM_MSWRITE_BIT(_REG_GPIO3_OUT, TRUE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, TRUE, BIT2))//(MEM_MSWRITE_BIT(_REG_GPIO3_OUT, TRUE, BIT7), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ,TRUE, BIT7))//, MEM_MSWRITE_BIT(REG_0262, FALSE, BIT3), MEM_MSWRITE_BIT(REG_0265, TRUE, BIT4))
#define hw_Clr_HdcpHpd()        	//(MEM_MSWRITE_BIT(_REG_GPIO3_OUT, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, FALSE, BIT2))//(MEM_MSWRITE_BIT(_REG_GPIO3_OUT, FALSE, BIT7), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, FALSE, BIT7))//, MEM_MSWRITE_BIT(REG_0262, FALSE, BIT3), MEM_MSWRITE_BIT(REG_0265, FALSE, BIT4))
#define Init_hwHDCP_Hpd_Pin()   	//(MEM_MSWRITE_BIT(_REG_GPIO3_OUT, TRUE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, TRUE, BIT2))//(MEM_MSWRITE_BIT(_REG_GPIO3_OUT, TRUE, BIT7), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, TRUE, BIT7))//, MEM_MSWRITE_BIT(REG_0262, FALSE, BIT3), MEM_MSWRITE_BIT(REG_0265, FALSE, BIT4)) //default low
//HDMI HPD
#define hw_Set_HdcpHpd2()       (MEM_MSWRITE_BIT(_REG_GPIO3_OUT, TRUE, BIT1), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, TRUE, BIT1))//(MEM_MSWRITE_BIT(_REG_GPIO3_OUT, TRUE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, TRUE, BIT2))
#define hw_Clr_HdcpHpd2()       (MEM_MSWRITE_BIT(_REG_GPIO3_OUT, TRUE, BIT1), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, TRUE, BIT1))//(MEM_MSWRITE_BIT(_REG_GPIO3_OUT, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, FALSE, BIT2))
#define Init_hwHDCP_Hpd_Pin2()  (MEM_MSWRITE_BIT(_REG_GPIO3_OUT, TRUE, BIT1), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, TRUE, BIT1))//(MEM_MSWRITE_BIT(_REG_GPIO3_OUT, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, FALSE, BIT2)) //default low
