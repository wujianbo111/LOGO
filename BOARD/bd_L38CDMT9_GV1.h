...
#ifndef _BD_L38CDMT9_GV1_
#define _BD_L38CDMT9_GV1_
...
#define Set_EEPROM_WP()             (MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, 1, BIT6),MEM_MSWRITE_BIT(_REG_GPIO3_OUT, 1, BIT6))
...
#else
#define hwDVICable_Pin 				(KEYPAD_SAR6)//	0//(_bit0_(MEM_MSREAD_BYTE(_REG_GPIO3_IN)))
#define Init_hwDVICable_Pin() 		(MEM_MSWRITE_BIT(REG_3A68,1,BIT6))	//(MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, 1, BIT0))
...
#define Init_NVRAM_I2C_SDA_Pin()			{INIT_HW_VGAI2C_SDA_PIN();INIT_HW_HDMII2C_SDA_PIN();}
#define Init_NVRAM_I2C_SCL_Pin()			{INIT_HW_VGAI2C_SCL_PIN();INIT_HW_HDMII2C_SCL_PIN();}
...
#define Set_i2c_SDA_HDMI1()			(MEM_MSWRITE_BIT(_REG_GPIO3_OEZ,TRUE,BIT3))
#define Clr_i2c_SDA_HDMI1()			(MEM_MSWRITE_BIT(_REG_GPIO3_OUT,FALSE,BIT3),MEM_MSWRITE_BIT(_REG_GPIO3_OEZ,FALSE,BIT3))
#define i2c_SDAHi_HDMI1()			(_bit3_(MEM_MSREAD_BYTE(_REG_GPIO3_IN)))
#define i2c_SDALo_HDMI1()			(!i2c_SDAHi_HDMI1())

#define Set_i2c_SCL_HDMI1()			(MEM_MSWRITE_BIT(_REG_GPIO3_OEZ,TRUE,BIT2))
#define Clr_i2c_SCL_HDMI1()			(MEM_MSWRITE_BIT(_REG_GPIO3_OUT,FALSE,BIT2),MEM_MSWRITE_BIT(_REG_GPIO3_OEZ,FALSE,BIT2))
#define i2c_SCLHi_HDMI1()			(_bit2_(MEM_MSREAD_BYTE(_REG_GPIO3_IN)))
#define i2c_SCLLo_HDMI1()			(!i2c_SCLHi_HDMI1())

#define Set_NVRAM_i2c_SDA()       		((EnableReadDDCType == HDMI_EDID)?Set_i2c_SDA_HDMI1():Set_i2c_SDA_VGA())
#define Clr_NVRAM_i2c_SDA()       		((EnableReadDDCType == HDMI_EDID)?Clr_i2c_SDA_HDMI1():Clr_i2c_SDA_VGA())
#define NVRAM_i2c_SDA_IS_HI()         ((EnableReadDDCType == HDMI_EDID)?i2c_SDAHi_HDMI1():i2c_SDAHi_VGA())
#define NVRAM_i2c_SDA_IS_LO()         ((EnableReadDDCType == HDMI_EDID)?i2c_SDALo_HDMI1():i2c_SDALo_VGA())
                                                                                                                                           
#define Set_NVRAM_i2c_SCL()          	((EnableReadDDCType == HDMI_EDID)?Set_i2c_SCL_HDMI1():Set_i2c_SCL_VGA())
#define Clr_NVRAM_i2c_SCL()           	((EnableReadDDCType == HDMI_EDID)?Clr_i2c_SCL_HDMI1():Clr_i2c_SCL_VGA())
#define NVRAM_i2c_SCL_IS_HI()         ((EnableReadDDCType == HDMI_EDID)?i2c_SCLHi_HDMI1():i2c_SCLHi_VGA())
#define NVRAM_i2c_SCL_IS_LO()         ((EnableReadDDCType == HDMI_EDID)?i2c_SCLLo_HDMI1():i2c_SCLLo_VGA())
...
#define Init_hwHDCP_Hpd2_Pin()  	 (MEM_MSWRITE_BIT(_REG_GPIO3_OUT, TRUE, BIT1), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, TRUE, BIT1), MEM_MSWRITE_BIT(REG_0262, TRUE, BIT2), MEM_MSWRITE_BIT(REG_0265, TRUE, BIT3)) //default low
