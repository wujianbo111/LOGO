...
//130708 petit
#define hw_SetDDC_WP()                  (MEM_MSWRITE_BIT(_REG_PMGPIO0_OEZ, 1, BIT5),MEM_MSWRITE_BIT(_REG_PMGPIO0_OUT, 1, BIT5))//, DDCWPActiveFlag=1)
#define hw_ClrDDC_WP()                  (MEM_MSWRITE_BIT(_REG_PMGPIO0_OEZ, 0, BIT5),MEM_MSWRITE_BIT(_REG_PMGPIO0_OUT, 0, BIT5))//, DDCWPActiveFlag=0)
#define Init_hwDDC_WP_Pin()         (MEM_MSWRITE_BIT(_REG_PMGPIO0_OEZ, 1, BIT5))//, DDCWPActiveFlag=1)
...
#define hw_ClrPanel()           MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 1, BIT6)
