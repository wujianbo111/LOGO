...
#if AudioFunc
#define VolumePWM               _PWM0_ // Not Finishhed Yet in CHIP_TSUMC
...
#define Init_HarphoneDet_Pin()        MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, 1, BIT4)//,  MEM_MSWRITE_BIT(_REG_GPIOL_OUT_H, 0, BIT1),MEM_MSWRITE_BIT(_REG_GPIOL_SEL_H, 0, BIT1)
#endif
...
#define hw_SetBlacklit()        (MEM_MSWRITE_BIT(_REG_GPIO0_OUT, 0, BIT3), BackLightActiveFlag=1)
#define hw_ClrBlacklit()        (MEM_MSWRITE_BIT(_REG_GPIO0_OUT, 1, BIT3), BackLightActiveFlag=0)
#define Init_hwBlacklit_Pin()   (MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, 0, BIT3))

#define hw_SetPanel()           MEM_MSWRITE_BIT(_REG_GPIO0_OUT, 1, BIT5)
...
#else
#define hwDSUBCable_Pin                     (_bit5_(MEM_MSREAD_BYTE(_REG_GPIO5_IN)))//(_bit7_(MEM_MSREAD_BYTE(_REG_GPIOSAR_IN)))  //SAR3
#define Init_hwDSUBCable_Pin()          (MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, 1, BIT5))//(MEM_MSWRITE_BIT(_REG_GPIOSAR_OEZ, 1, BIT3))
...
#else
#define hwDVICable_Pin     				0//(_bit5_(MEM_MSREAD_BYTE(_REG_GPIO5_IN))) // 130530 JUN Modify
#define Init_hwDVICable_Pin()   		//(MEM_MSWRITE_BIT(_REG_GPIO5_OEZ,1,BIT5)) // input enable
#define CABLE_DET_DVI_SAR    			0
#endif

#if ENABLE_HDMI
#define hwHDMICable_Pin   			(_bit1_(MEM_MSREAD_BYTE(_REG_GPIO3_IN)))//(KEYPAD_SAR5)//
#define Init_hwHDMICable_Pin()  		(MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, 1, BIT1))//(MEM_MSWRITE_BIT(REG_3A68,1,BIT5))
...
#define INIT_HWI2C_SDA_PIN()	(MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, TRUE, BIT5))
#define INIT_HWI2C_SCL_PIN()	(MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, TRUE, BIT5))
...
#define hw_Set_I2C_SDA_Pin		(MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, TRUE, BIT5))
#define hw_Clr_I2C_SDA_Pin		(MEM_MSWRITE_BIT(_REG_GPIO2_OUT, FALSE, BIT5), MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, FALSE, BIT5))
#define hw_I2C_SDA_HI                  (_bit5_(MEM_MSREAD_BYTE(_REG_GPIO2_IN)))
#define hw_I2C_SDA_LO                  (!hw_I2C_SDA_HI)


#define hw_Set_I2C_SCL_Pin		(MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, TRUE, BIT5))
#define hw_Clr_I2C_SCL_Pin		(MEM_MSWRITE_BIT(_REG_GPIO2_OUT, FALSE, BIT5), MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, FALSE, BIT5))
#define hw_I2C_SCL_HI		       (_bit5_(MEM_MSREAD_BYTE(_REG_GPIO2_IN)))
...
//DVI HPD
#define hw_Set_HdcpHpd()        	(MEM_MSWRITE_BIT(_REG_GPIO3_OUT, TRUE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ,TRUE, BIT2))//, MEM_MSWRITE_BIT(REG_0262, FALSE, BIT3), MEM_MSWRITE_BIT(REG_0265, TRUE, BIT4))
#define hw_Clr_HdcpHpd()        	(MEM_MSWRITE_BIT(_REG_GPIO3_OUT, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, FALSE, BIT2))//, MEM_MSWRITE_BIT(REG_0262, FALSE, BIT3), MEM_MSWRITE_BIT(REG_0265, FALSE, BIT4))
#define Init_hwHDCP_Hpd_Pin()   	(MEM_MSWRITE_BIT(_REG_GPIO3_OUT, TRUE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, TRUE, BIT2))//, MEM_MSWRITE_BIT(REG_0262, FALSE, BIT3), MEM_MSWRITE_BIT(REG_0265, FALSE, BIT4)) //default low
//HDMI HPD
...
#define SAR2_EN     BIT2
#define SAR3_EN     BIT3
#define SARKEY_EN    (SAR2_EN|SAR3_EN)//(SAR1_EN|SAR2_EN)
