...
#define DFT_MUX_Uart0           UART0_GPIO34_35 // default mux uart 0 - VGA
...
#define CInput_DVI_C3           CInput_Digital
...
#define DVI_SLAVE_PORT          TMDS_PORT_A//TMDS_PORT_UNUSE
...
#define PowerKey               		(_bit0_(msReadByte(_REG_PMGPIOSAR_IN)))//  (MEM_MSREAD_BYTE(REG_3A20))
...
#define Init_NVRAM_I2C_SDA_Pin()			{INIT_HWI2C_SDA_PIN();INIT_HW_HDMI2I2C_SDA_PIN();INIT_HW_HDMII2C_SDA_PIN();}
#define Init_NVRAM_I2C_SCL_Pin()			{INIT_HWI2C_SCL_PIN();INIT_HW_HDMI2I2C_SCL_PIN();INIT_HW_HDMII2C_SCL_PIN();}
...
#define Set_NVRAM_i2c_SDA()		      		((EnableReadDDCType==I2C_EEPROM)?hw_Set_I2C_SDA_Pin:((EnableReadDDCType==DVI_EDID)?Set_i2c_SDA_HDMI():(Set_i2c_SDA_HDMI2())))
#define Clr_NVRAM_i2c_SDA()		              ((EnableReadDDCType==I2C_EEPROM)?hw_Clr_I2C_SDA_Pin:((EnableReadDDCType==DVI_EDID)?Clr_i2c_SDA_HDMI():(Clr_i2c_SDA_HDMI2())))
#define NVRAM_i2c_SDA_IS_HI()			((EnableReadDDCType==I2C_EEPROM)?hw_I2C_SDA_HI:((EnableReadDDCType==DVI_EDID)?i2c_SDAHi_HDMI():(i2c_SDAHi_HDMI2())))
#define NVRAM_i2c_SDA_IS_LO()			((EnableReadDDCType==I2C_EEPROM)?hw_I2C_SDA_LO:((EnableReadDDCType==DVI_EDID)?i2c_SDALo_HDMI():(i2c_SDALo_HDMI2())))

#define Set_NVRAM_i2c_SCL()			      	((EnableReadDDCType==I2C_EEPROM)?hw_Set_I2C_SCL_Pin:((EnableReadDDCType==DVI_EDID)?Set_i2c_SCL_HDMI():(Set_i2c_SCL_HDMI2())))
#define Clr_NVRAM_i2c_SCL()			      	((EnableReadDDCType==I2C_EEPROM)?hw_Clr_I2C_SCL_Pin:((EnableReadDDCType==DVI_EDID)?Clr_i2c_SCL_HDMI():(Clr_i2c_SCL_HDMI2())))
#define NVRAM_i2c_SCL_IS_HI()			((EnableReadDDCType==I2C_EEPROM)?hw_I2C_SCL_HI:((EnableReadDDCType==DVI_EDID)?i2c_SCLHi_HDMI():(i2c_SCLHi_HDMI2())))
#define NVRAM_i2c_SCL_IS_LO()			((EnableReadDDCType==I2C_EEPROM)?hw_I2C_SCL_LO:((EnableReadDDCType==DVI_EDID)?i2c_SCLLo_HDMI():(i2c_SCLLo_HDMI2())))
...
#define hw_Set_HdcpHpd3()        //(MEM_MSWRITE_BIT(_REG_PMGPIO2_OUT, FALSE, BIT0), MEM_MSWRITE_BIT(_REG_PMGPIO2_OEZ, FALSE, BIT0))//(MEM_MSWRITE_BIT(_REG_PMGPIO1_OUT, FALSE, BIT5), MEM_MSWRITE_BIT(_REG_PMGPIO1_OEZ, FALSE, BIT5))  //(MEM_MSWRITE_BIT(_REG_PMGPIO2_OUT, FALSE, BIT0), MEM_MSWRITE_BIT(_REG_PMGPIO2_OEZ, FALSE, BIT0))   
#define hw_Clr_HdcpHpd3()          //(MEM_MSWRITE_BIT(_REG_PMGPIO2_OUT, TRUE, BIT0), MEM_MSWRITE_BIT(_REG_PMGPIO2_OEZ, FALSE, BIT0))//(MEM_MSWRITE_BIT(_REG_PMGPIO1_OUT, TRUE, BIT5), MEM_MSWRITE_BIT(_REG_PMGPIO1_OEZ, TRUE, BIT5))   //(MEM_MSWRITE_BIT(_REG_PMGPIO2_OUT, TRUE, BIT0), MEM_MSWRITE_BIT(_REG_PMGPIO2_OEZ, FALSE, BIT0))
...
#define hw_Set_HdcpHpd()         (MEM_MSWRITE_BIT(_REG_PMGPIO2_OUT, FALSE, BIT0), MEM_MSWRITE_BIT(_REG_PMGPIO2_OEZ, FALSE, BIT0)) //(MEM_MSWRITE_BIT(_REG_PMGPIO1_OUT, FALSE, BIT5), MEM_MSWRITE_BIT(_REG_PMGPIO1_OEZ, FALSE, BIT5)) // (MEM_MSWRITE_BIT(_REG_PMGPIO1_OUT, FALSE, BIT5), MEM_MSWRITE_BIT(_REG_PMGPIO1_OEZ, FALSE, BIT5))  
#define hw_Clr_HdcpHpd()           (MEM_MSWRITE_BIT(_REG_PMGPIO2_OUT, TRUE, BIT0), MEM_MSWRITE_BIT(_REG_PMGPIO2_OEZ, FALSE, BIT0))// (MEM_MSWRITE_BIT(_REG_PMGPIO1_OUT, TRUE, BIT5), MEM_MSWRITE_BIT(_REG_PMGPIO1_OEZ, TRUE, BIT5)) // (MEM_MSWRITE_BIT(_REG_PMGPIO1_OUT, TRUE, BIT5), MEM_MSWRITE_BIT(_REG_PMGPIO1_OEZ, FALSE, BIT5))
