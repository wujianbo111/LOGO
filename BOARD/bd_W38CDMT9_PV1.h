...
#define Init_HarphoneDet_Pin()        	(MEM_MSWRITE_BIT(_REG_GPIOL_OEZ_H,0, BIT1),MEM_MSWRITE_BIT(_REG_GPIOL_OUT_H, 1, BIT1),MEM_MSWRITE_BIT(_REG_GPIOL_SEL_H, 0, BIT1))
#endif

#define PowerKey        				(_bit4_(MEM_MSREAD_BYTE(_REG_GPIOSAR_IN)))
#define Init_PowerKey() 				(MEM_MSWRITE_BIT(_REG_GPIOSAR_OEZ, 1, BIT4))
#define PM_POWERKEY_WAKEUP      	_REG_GPIOSAR_IN
...
#define Init_hwBlacklit_Pin()   		(MEM_MSWRITE_BIT(_REG_GPIOL_OEZ_H, 0, BIT3))

#define hw_SetPanel()          		 MEM_MSWRITE_BIT(_REG_GPIOL_OUT_H, 1, BIT0)
#define hw_ClrPanel()          		 MEM_MSWRITE_BIT(_REG_GPIOL_OUT_H, 0, BIT0)
#define Init_hwPanel_Pin()      		(MEM_MSWRITE_BIT(_REG_GPIOL_OEZ_H, 0, BIT0)) // output enable
...
#else
#define hwDSUBCable_Pin                     (_bit1_(MEM_MSREAD_BYTE(_REG_GPIO5_IN)))//(_bit7_(MEM_MSREAD_BYTE(_REG_GPIOSAR_IN)))  //SAR3
#define Init_hwDSUBCable_Pin()          (MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, 1, BIT1))//(MEM_MSWRITE_BIT(_REG_GPIOSAR_OEZ, 1, BIT3))
...
#else
#define hwDVICable_Pin     				(_bit5_(MEM_MSREAD_BYTE(_REG_GPIO5_IN)))//(_bit5_(MEM_MSREAD_BYTE(_REG_GPIO5_IN))) // 130530 JUN Modify
#define Init_hwDVICable_Pin()   			(MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, 1, BIT5))//(MEM_MSWRITE_BIT(_REG_GPIO5_OEZ,1,BIT5)) // input enable
...
#else
#define hwHDMICable_Pin   			(_bit0_(MEM_MSREAD_BYTE(_REG_GPIO3_IN)))//(KEYPAD_SAR5)//(_bit0_(MEM_MSREAD_BYTE(_REG_GPIO3_IN)))
#define Init_hwHDMICable_Pin()  		(MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, 1, BIT0))//(MEM_MSWRITE_BIT(REG_3A68,1,BIT5))//(MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, 1, BIT0))
#define CABLE_DET_HDMI_SAR    		0
#endif

#if ENABLE_DP_INPUT
#define hwDPCable_Pin        			(_bit0_(MEM_MSREAD_BYTE(_REG_GPIOL_IN_L)))
#define Init_hwDPCable_Pin()  		(MEM_MSWRITE_BIT(_REG_GPIOL_OEZ_L, 1, BIT0))//(MEM_MSWRITE_BIT(REG_3A68,1,BIT5))//(MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, 1, BIT0))
#endif
...
#define hw_SetMute()        		(MEM_MSWRITE_BIT(_REG_GPIO0_OUT, TRUE,  BIT1)) // 130530 JUN Modify
...
#define INIT_HWI2C_SDA_PIN()	(MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, TRUE, BIT0))
#define INIT_HWI2C_SCL_PIN()	(MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, TRUE, BIT0))

#define hw_Set_I2C_SDA_Pin		(MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, TRUE, BIT0))
#define hw_Clr_I2C_SDA_Pin		(MEM_MSWRITE_BIT(_REG_GPIO0_OUT, FALSE, BIT0), MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, FALSE, BIT0))
#define hw_I2C_SDA_HI                  (_bit0_(MEM_MSREAD_BYTE(_REG_GPIO0_IN)))
#define hw_I2C_SDA_LO                  (!hw_I2C_SDA_HI)


#define hw_Set_I2C_SCL_Pin		(MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, TRUE, BIT0))
#define hw_Clr_I2C_SCL_Pin		(MEM_MSWRITE_BIT(_REG_GPIO0_OUT, FALSE, BIT0), MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, FALSE, BIT0))
#define hw_I2C_SCL_HI		       (_bit0_(MEM_MSREAD_BYTE(_REG_GPIO0_IN)))
#define hw_I2C_SCL_LO			(!hw_I2C_SCL_HI)


#define Init_NVRAM_I2C_SDA_Pin()		{INIT_HWI2C_SDA_PIN();INIT_HW_HDMI2I2C_SDA_PIN();INIT_HW_HDMII2C_SDA_PIN();INIT_HW_VGAI2C_SDA_PIN();}
#define Init_NVRAM_I2C_SCL_Pin()			{INIT_HWI2C_SCL_PIN();INIT_HW_HDMI2I2C_SCL_PIN();INIT_HW_HDMII2C_SCL_PIN();INIT_HW_VGAI2C_SCL_PIN();}
...
#define INIT_HW_HDMI2I2C_SDA_PIN()    		(MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, TRUE, BIT5))
#define INIT_HW_HDMI2I2C_SCL_PIN()    		(MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, TRUE, BIT4))

#define Set_i2c_SDA_HDMI2()           			(MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, TRUE, BIT5))
#define Clr_i2c_SDA_HDMI2()           			(MEM_MSWRITE_BIT(_REG_GPIO3_OUT, FALSE, BIT5), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, FALSE, BIT5))
#define i2c_SDAHi_HDMI2()              			(_bit5_(MEM_MSREAD_BYTE(_REG_GPIO3_IN)))
#define i2c_SDALo_HDMI2()              			(!i2c_SDAHi_HDMI2())

#define Set_i2c_SCL_HDMI2()           			(MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, TRUE, BIT4))
#define Clr_i2c_SCL_HDMI2()           			(MEM_MSWRITE_BIT(_REG_GPIO3_OUT, FALSE, BIT4), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, FALSE, BIT4))
#define i2c_SCLHi_HDMI2()             			(_bit4_(MEM_MSREAD_BYTE(_REG_GPIO3_IN)))
