...
#define Input_HDMI_C2           Input_Digital2//Input_HDMI//
#define Input_HDMI_C3           Input_Nothing
#define Input_Displayport_C2    Input_Nothing
#define Input_Displayport_C3    Input_Displayport3
...
#define CInput_HDMI_C2          CInput_Digital2//CInput_Nothing
...
//#define Init_BrightnessPWM()    	{ MEM_MSWRITE_BYTE_MASK(REG_1B0B,BIT5,BIT5);MEM_MSWRITE_BYTE_MASK(REG_1B09,BIT5,BIT5);}

#define BrightnessPWM          _PWM3_ // 
#define Init_BrightnessPWM()  	 MEM_MSWRITE_BYTE_MASK(REG_1B0B,BIT5,BIT5)// { MEM_MSWRITE_BYTE_MASK(REG_1B09,BIT5,BIT5);MEM_MSWRITE_BYTE_MASK(REG_1B0B,BIT5,BIT5);}
#define Disable_BrightnessPWM()	{ MEM_MSWRITE_BYTE_MASK(REG_1B0B,0,BIT5);}
#define hw_SetBrightnessPWMHI()    	{MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, 0, BIT5);\
...
#define Init_VolumePWM()        	{ MEM_MSWRITE_BYTE_MASK(REG_1B08,BIT6,BIT6);}
#endif

#if EarphoneDet_Enable
#define HarphoneDet_Pin                 	(!(_bit7_(MEM_MSREAD_BYTE(_REG_PMGPIO2_IN))))
#define Init_HarphoneDet_Pin()        	(MEM_MSWRITE_BIT(_REG_PMGPIO2_OEZ,1, BIT7),MEM_MSWRITE_BIT(_REG_PMGPIO2_OUT, 0, BIT7))
#endif

#define PowerKey        				(_bit0_(MEM_MSREAD_BYTE(_REG_PMGPIOSAR_IN)))
#define Init_PowerKey() 				(MEM_MSWRITE_BIT(_REG_PMGPIOSAR_OEZ, 1, BIT4))
#define PM_POWERKEY_WAKEUP      	_REG_PMGPIOSAR_IN
...
//130708 petit
#define hw_SetDDC_WP()                  (MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, 0, BIT4),MEM_MSWRITE_BIT(_REG_GPIO3_OUT, 1, BIT4))//, DDCWPActiveFlag=1)
#define hw_ClrDDC_WP()                  (MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, 0, BIT4),MEM_MSWRITE_BIT(_REG_GPIO3_OUT, 0, BIT4))//, DDCWPActiveFlag=0)
#define Init_hwDDC_WP_Pin()         (MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, 0, BIT4),MEM_MSWRITE_BIT(_REG_GPIO3_OUT, 1, BIT4))//, DDCWPActiveFlag=1)

#define Set_EEPROM_WP()            	(MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, 0, BIT4),MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 1, BIT4))
#define Clr_EEPROM_WP()          	 (MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, 0, BIT4),MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 0, BIT4))
#define Init_hwEEPROM_WP()       	  (MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, 0, BIT4),MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 1, BIT4))
...
#define hwPanel_Pin
#define hw_SetBlacklit()    (MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 0, BIT7), BackLightActiveFlag=1)//{MEM_MSWRITE_BIT(_REG_GPIO0_OUT, 1, BIT5); BackLightActiveFlag=1;}
#define hw_ClrBlacklit()    (MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 1, BIT7), BackLightActiveFlag=0)//{MEM_MSWRITE_BIT(_REG_GPIO0_OUT, 0, BIT5); BackLightActiveFlag=0;}
...
#else
#define hwDSUBCable_Pin                     (_bit3_(MEM_MSREAD_BYTE(_REG_GPIO1_IN)))//(_bit7_(MEM_MSREAD_BYTE(_REG_GPIOSAR_IN)))  //SAR3
#define Init_hwDSUBCable_Pin()          (MEM_MSWRITE_BIT(_REG_GPIO1_OEZ, 1, BIT3))//(MEM_MSWRITE_BIT(_REG_GPIOSAR_OEZ, 1, BIT3))
...
#else
#define hwDVICable_Pin     				(_bit5_(MEM_MSREAD_BYTE(_REG_GPIO3_IN)))//(_bit5_(MEM_MSREAD_BYTE(_REG_GPIO5_IN))) // 130530 JUN Modify
#define Init_hwDVICable_Pin()   			(MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, 1, BIT2))//(MEM_MSWRITE_BIT(_REG_GPIO5_OEZ,1,BIT5)) // input enable
#define CABLE_DET_DVI_SAR    			0
#endif

#if ENABLE_HDMI
#define hwHDMICable_Pin   			(_bit0_(MEM_MSREAD_BYTE(_REG_GPIO3_IN)))
#define Init_hwHDMICable_Pin()  		(MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, 1, BIT0))//(MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, 1, BIT0))
#define CABLE_DET_HDMI_SAR    		0
#else
#define hwHDMICable_Pin   			0
#define Init_hwHDMICable_Pin()  		0
#endif

#if ENABLE_DP_INPUT
#define hwDPCable_Pin        			(_bit0_(MEM_MSREAD_BYTE(_REG_GPIO3_IN)))
#define Init_hwDPCable_Pin()  		(MEM_MSWRITE_BIT(_REG_GPIO3_IN, 1, BIT0))//(MEM_MSWRITE_BIT(REG_3A68,1,BIT5))//(MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, 1, BIT0))
#endif
...
#define hw_SetGreenLed()               {MEM_MSWRITE_BIT(_REG_GPIO1_OEZ,0,BIT1);MEM_MSWRITE_BIT(_REG_GPIO1_OUT,1,BIT1);}
#define hw_ClrGreenLed()                {MEM_MSWRITE_BIT(_REG_GPIO1_OEZ,1,BIT1);MEM_MSWRITE_BIT(_REG_GPIO1_OUT,0,BIT1);}
#define Init_hwGreenLed_Pin()         MEM_MSWRITE_BIT(_REG_GPIO1_OEZ, 1,BIT1)// output enable
...
#define hw_SetMute()        		(MEM_MSWRITE_BIT(_REG_GPIO0_OUT, TRUE,  BIT0)) // 130530 JUN Modify
#define hw_ClrMute()        			(MEM_MSWRITE_BIT(_REG_GPIO0_OUT, FALSE, BIT0))
#define Init_hwMute_Pin()			(MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, FALSE, BIT0))
...
#define hw_Set_I2C_SDA_Pin		(MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, TRUE, BIT7))
#define hw_Clr_I2C_SDA_Pin		(MEM_MSWRITE_BIT(_REG_GPIO0_OUT, FALSE, BIT7), MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, FALSE, BIT7))
#define hw_I2C_SDA_HI                  (_bit7_(MEM_MSREAD_BYTE(_REG_GPIO0_IN)))
#define hw_I2C_SDA_LO                  (!hw_I2C_SDA_HI)


#define hw_Set_I2C_SCL_Pin		(MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, TRUE, BIT6))
#define hw_Clr_I2C_SCL_Pin		(MEM_MSWRITE_BIT(_REG_GPIO0_OUT, FALSE, BIT6), MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, FALSE, BIT6))
#define hw_I2C_SCL_HI		       (_bit6_(MEM_MSREAD_BYTE(_REG_GPIO0_IN)))
...
#define INIT_HW_HDMII2C_SDA_PIN()    		(MEM_MSWRITE_BIT(_REG_PMGPIO1_OEZ, TRUE, BIT3))
#define INIT_HW_HDMII2C_SCL_PIN()    		(MEM_MSWRITE_BIT(_REG_PMGPIO1_OEZ, TRUE, BIT2))

#define Set_i2c_SDA_HDMI()           			(MEM_MSWRITE_BIT(_REG_PMGPIO1_OEZ, TRUE, BIT3))
#define Clr_i2c_SDA_HDMI()           			(MEM_MSWRITE_BIT(_REG_PMGPIO1_OUT, FALSE, BIT3), MEM_MSWRITE_BIT(_REG_PMGPIO1_OEZ, FALSE, BIT3))
#define i2c_SDAHi_HDMI()              			(_bit3_(MEM_MSREAD_BYTE(_REG_PMGPIO1_IN)))
#define i2c_SDALo_HDMI()              			(!i2c_SDAHi_HDMI())

#define Set_i2c_SCL_HDMI()           			(MEM_MSWRITE_BIT(_REG_PMGPIO1_OEZ, TRUE, BIT2))
#define Clr_i2c_SCL_HDMI()           			(MEM_MSWRITE_BIT(_REG_PMGPIO1_OUT, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_PMGPIO1_OEZ, FALSE, BIT2))
#define i2c_SCLHi_HDMI()             				(_bit2_(MEM_MSREAD_BYTE(_REG_PMGPIO1_IN)))
...
//DVI HPD
#define hw_Set_HdcpHpd()        	(MEM_MSWRITE_BIT(_REG_PMGPIO1_OUT, 0, BIT4), MEM_MSWRITE_BIT(_REG_PMGPIO1_OEZ,0, BIT4))//, MEM_MSWRITE_BIT(REG_0262, FALSE, BIT3), MEM_MSWRITE_BIT(REG_0265, TRUE, BIT4))
#define hw_Clr_HdcpHpd()        	(MEM_MSWRITE_BIT(_REG_PMGPIO1_OUT, 1, BIT4), MEM_MSWRITE_BIT(_REG_PMGPIO1_OEZ, 0, BIT4))//, MEM_MSWRITE_BIT(REG_0262, FALSE, BIT3), MEM_MSWRITE_BIT(REG_0265, FALSE, BIT4))
#define Init_hwHDCP_Hpd_Pin()   	(MEM_MSWRITE_BIT(_REG_PMGPIO1_OUT, 0, BIT4), MEM_MSWRITE_BIT(_REG_PMGPIO1_OEZ, 0, BIT4))//, MEM_MSWRITE_BIT(REG_0262, FALSE, BIT3), MEM_MSWRITE_BIT(REG_0265, FALSE, BIT4)) //default low
//HDMI HPD
#define hw_Set_HdcpHpd2()         	(MEM_MSWRITE_BIT(_REG_PMGPIO1_OUT, 0, BIT5), MEM_MSWRITE_BIT(_REG_PMGPIO1_OEZ,0, BIT5)) //, MEM_MSWRITE_BIT(REG_0262, TRUE, BIT2), MEM_MSWRITE_BIT(REG_0265, TRUE, BIT3))
#define hw_Clr_HdcpHpd2()         	 (MEM_MSWRITE_BIT(_REG_PMGPIO1_OUT, 1, BIT5), MEM_MSWRITE_BIT(_REG_PMGPIO1_OEZ,0, BIT5))//, MEM_MSWRITE_BIT(REG_0262, TRUE, BIT2), MEM_MSWRITE_BIT(REG_0265, TRUE, BIT3))
#define Init_hwHDCP_Hpd2_Pin()  	(MEM_MSWRITE_BIT(_REG_PMGPIO1_OUT, 0, BIT5), MEM_MSWRITE_BIT(_REG_PMGPIO1_OEZ, 0, BIT5))//, MEM_MSWRITE_BIT(REG_0262, FALSE, BIT2), MEM_MSWRITE_BIT(REG_0265, FALSE, BIT3)) //default low
...
#define hw_Clr_HdcpHpd3()       	//(MEM_MSWRITE_BIT(_REG_GPIO5_OUT, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, FALSE, BIT2), MEM_MSWRITE_BIT(REG_0262, TRUE, BIT5), MEM_MSWRITE_BIT(REG_0265, TRUE, BIT5))
