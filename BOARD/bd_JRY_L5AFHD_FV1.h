...
#define  BoardName			"JRY-L5AFHD-FV1"
...
//130708 petit
#define hw_SetDDC_WP()                  (MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, 1, BIT3),MEM_MSWRITE_BIT(_REG_GPIO3_OUT, 1, BIT3))//, DDCWPActiveFlag=1)
...
*/
#define hw_SetAmberLed()                  {MEM_MSWRITE_BIT(_REG_GPIO2_OEZ,0,BIT2);MEM_MSWRITE_BIT(_REG_GPIO2_OUT,1,BIT2);}//  (MEM_MSWRITE_BIT(_REG_GPIO2_OEZ,0,BIT2),MEM_MSWRITE_BIT(_REG_GPIO2_OUT,0,BIT2))
#define hw_ClrAmberLed()                   {MEM_MSWRITE_BIT(_REG_GPIO2_OEZ,1,BIT2);MEM_MSWRITE_BIT(_REG_GPIO2_OUT,0,BIT2);}// MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, 1,BIT2)
#define Init_hwAmberLed_Pin()            MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, 1,BIT2)// output enable// output enable//  MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, 1,BIT2)// output enable

#define hw_SetGreenLed()                {MEM_MSWRITE_BIT(_REG_GPIO2_OEZ,0,BIT3);MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 1, BIT3);}
#define hw_ClrGreenLed()                {MEM_MSWRITE_BIT(_REG_GPIO2_OEZ,1,BIT3);MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 0, BIT3);}
#define Init_hwGreenLed_Pin()          MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, 1,BIT3)// output enable
...
#define hw_Clr_I2C_SDA_Pin		(MEM_MSWRITE_BIT(_REG_GPIO0_OUT, FALSE, BIT0), MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, FALSE, BIT0))
...
#define Init_NVRAM_I2C_SDA_Pin()			{INIT_HWI2C_SDA_PIN();INIT_HW_HDMII2C_SDA_PIN();}
#define Init_NVRAM_I2C_SCL_Pin()			{INIT_HWI2C_SCL_PIN();INIT_HW_HDMII2C_SCL_PIN();}
...
#define Set_NVRAM_i2c_SDA()		      			((EnableReadDDCType==I2C_EEPROM)?hw_Set_I2C_SDA_Pin:Set_i2c_SDA_HDMI())
#define Clr_NVRAM_i2c_SDA()		              	((EnableReadDDCType==I2C_EEPROM)?hw_Clr_I2C_SDA_Pin:Clr_i2c_SDA_HDMI())
#define NVRAM_i2c_SDA_IS_HI()			      	((EnableReadDDCType==I2C_EEPROM)?hw_I2C_SDA_HI:i2c_SDAHi_HDMI())
#define NVRAM_i2c_SDA_IS_LO()			      	((EnableReadDDCType==I2C_EEPROM)?hw_I2C_SDA_LO:i2c_SDALo_HDMI())

#define Set_NVRAM_i2c_SCL()			      		((EnableReadDDCType==I2C_EEPROM)?hw_Set_I2C_SCL_Pin:Set_i2c_SCL_HDMI())
#define Clr_NVRAM_i2c_SCL()			      		((EnableReadDDCType==I2C_EEPROM)?hw_Clr_I2C_SCL_Pin:Clr_i2c_SCL_HDMI())
#define NVRAM_i2c_SCL_IS_HI()			      	((EnableReadDDCType==I2C_EEPROM)?hw_I2C_SCL_HI:i2c_SCLHi_HDMI())
#define NVRAM_i2c_SCL_IS_LO()			      	((EnableReadDDCType==I2C_EEPROM)?hw_I2C_SCL_LO:i2c_SCLLo_HDMI())
#endif
...
//DVI HPD
#define hw_Set_HdcpHpd()       (MEM_MSWRITE_BIT(_REG_GPIO3_OUT, TRUE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, TRUE, BIT2))
#define hw_Clr_HdcpHpd()       (MEM_MSWRITE_BIT(_REG_GPIO3_OUT, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, FALSE, BIT2))
#define Init_hwHDCP_Hpd_Pin()  (MEM_MSWRITE_BIT(_REG_GPIO3_OUT, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, FALSE, BIT2)) //default low
//HDMI HPD
