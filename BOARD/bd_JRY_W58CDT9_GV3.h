...
#define BoardName "JRY-L58CDT9-GV3"
...
//130708 petit
#define hw_SetDDC_WP()                  (MEM_MSWRITE_BIT(_REG_GPIO3_OUT,1, BIT3),MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, 1, BIT3))//, DDCWPActiveFlag=1)
#define hw_ClrDDC_WP()                  (MEM_MSWRITE_BIT(_REG_GPIO3_OUT,0, BIT3),MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, 0, BIT3))//, DDCWPActiveFlag=0)
...
#define INIT_HWI2C_SDA_PIN()	(MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, TRUE, BIT6))
#define INIT_HWI2C_SCL_PIN()	(MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, TRUE, BIT6))

#define hw_Set_I2C_SDA_Pin		(MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, TRUE, BIT6))
#define hw_Clr_I2C_SDA_Pin		(MEM_MSWRITE_BIT(_REG_GPIO2_OUT, FALSE, BIT6), MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, FALSE, BIT6))
#define hw_I2C_SDA_HI                  (_bit6_(MEM_MSREAD_BYTE(_REG_GPIO2_IN)))
#define hw_I2C_SDA_LO                  (!hw_I2C_SDA_HI)


#define hw_Set_I2C_SCL_Pin		(MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, TRUE, BIT6))
#define hw_Clr_I2C_SCL_Pin		(MEM_MSWRITE_BIT(_REG_GPIO2_OUT, FALSE, BIT6), MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, FALSE, BIT6))
#define hw_I2C_SCL_HI		       (_bit6_(MEM_MSREAD_BYTE(_REG_GPIO2_IN)))
